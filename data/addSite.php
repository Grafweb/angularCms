...
$dane = $db->prepare("INSERT INTO pages (id_parent,title,content,category,meta_title,meta_description,meta_key,component_galery) VALUES (:id_parent,:title,:content,:category,:meta_title,:meta_description,:meta_key,:component_galery)");
